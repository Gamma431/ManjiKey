...
export default function Keyboard() {
  ...
  return (
    <motion.div initial={{ opacity: 0, transform:"translateY(200px)"}} animate={{ opacity: 1, transform:"translateY(0)" }} transition={{duration:1, ease:"easeInOut"}} className='w-full h-auto p-[2%]'>
      <div className='w-full h-full flex gap-3'>
        <motion.div initial={{ opacity: 0, transform:"translateX(-200px)"}} animate={{ opacity: 1, transform:"translateX(0)" }} transition={{duration:1, ease:"easeInOut",delay:0.5}} className='w-[25%] h-[90vh] bg-gray-900 rounded-[15px] p-[1%] '>
          <div className="h-[10%] w-full flex text-white justify-center items-center">
          ...
          <div className="w-full h-[20%] text-white p-[3%]">
            <h2 className="text-[23px] mx-[2%]">Price Range</h2>
            <input type="range" className="w-full "/>
            <p className="text-[20px] text-center">$0 - $600</p>
          </div>
          <div className="w-full h-[37%] flex flex-col text-white p-[2%]">
          ...
          <div className="w-full h-[30%] flex flex-col text-white p-[2%]">
