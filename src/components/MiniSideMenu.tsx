...
export default function MiniSideMenu() {
    return (
        <motion.div whileHover={{width:"5vw",height:"22vh", left:"94vw",fontSize:"16px"}} className="left-[98vw] text-[0px] bg-gray-800 w-[1%] h-[10vh] z-1000  fixed bottom-0 top-[50vh] flex flex-col items-center justify-center py-1 rounded-3xl text-white ">
